...
def _one_dof(link: Link, j: Transform, jd: Motion, dof: DoF, tau: jax.Array) -> Force:
...
def _two_dof(link: Link, j: Transform, jd: Motion, dof: DoF, tau: jax.Array) -> Force:
...
def _three_dof(link: Link, j: Transform, jd: Motion, dof: DoF, tau: jax.Array) -> Force:
