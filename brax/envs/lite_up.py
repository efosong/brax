...
class LiteUp(PipelineEnv):
    """
    ### Description
    Simple test implementation of the lite6 robotic arm, with the goal of
    moving the end effector with maximum possible vertical speed.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        path = epath.resource_path("brax") / "envs/assets/lite6.xml"
